...
public class IdleState:State
{
    ...
    {
        myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 0, -200));
        myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(-300, 0, 0));
        myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(0, 0, 200));
        myGameObject.GetComponent<SteeringBehaviours>().path.Waypoints.Add(new Vector3(250, 0, -100));
